############################################
## Project: RP DRexML
## Script purpose:  Cluster Analysis between the relevant KDTs + cluster behaviour along hallmarks
## Date: 25.02.2023
...
p_load("here","cluster", "factoextra","NbClust","tidyr", "tibble")
...
clusters <- data.frame( CLUSTER = k$cluster) %>% rownames_to_column("KDT")
...
## Añadimos los clusters a los datos de hallmarks
